    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown active">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-hand-point-right"></i><span>Advertisement
                    </span></a>
                <ul class="dropdown-menu">
                    <li class="active"><a class="nav-link" href=""><i class="fas fa-angle-right"></i> Top Advertisement
                        </a></li>

                    <li class="active"><a class="nav-link" href="{{route('admin.home_advertisement')}}"><i
                                class="fas fa-angle-right"></i> Home Advertisement
                        </a></li>
                    <li class="active"><a class="nav-link" href=""><i class="fas fa-angle-right"></i>Sidebar
                            Advertisement
                        </a></li>
                    <li class=""><a class="nav-link" href=""><i class="fas fa-angle-right"></i> Footer</a>
                    </li>
                </ul>
            </li>
