        ...
        <div class="row">
            <div class="col-md-12">
                <div class="acme-news-ticker">
                    ...
                    <div id="my-news-ticker-container">
                        <div class="slick-slider">
                            <ul class="my-news-ticker">
                                <li><a href="#">Helicopter crashes into waves off crowded Miami beach</a></li>
                                <li><a href="#">New study shows benefits of exercise for mental health</a></li>
                                <li><a href="#">Local community raises funds to help homeless shelter</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
